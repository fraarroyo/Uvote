...
class Election(db.Model):
    ...
    positions = db.relationship('Position', back_populates='election', lazy=True)
...
class Candidate(db.Model):
    ...
    college = db.relationship('College', backref='candidates')
...
class StudentNumber(db.Model):
    ...
    user_list = db.relationship('UserList', backref=db.backref('student_numbers', lazy=True))
